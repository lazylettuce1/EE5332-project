...
// wrapc file define:
#define AUTOTB_TVIN_x_in "../tv/cdatafile/c.fir_mmio.autotvin_x_in.dat"
#define AUTOTB_TVOUT_x_in "../tv/cdatafile/c.fir_mmio.autotvout_x_in.dat"
// wrapc file define:
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.fir_mmio.autotvout_ap_return.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_x_in "../tv/rtldatafile/rtl.fir_mmio.autotvout_x_in.dat"
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.fir_mmio.autotvout_ap_return.dat"
...
extern "C" float fir_mmio_hw_stub_wrapper(float);

extern "C" float apatb_fir_mmio_hw(float __xlx_apatb_param_x_in) {
...
//x_in
aesl_fh.touch(AUTOTB_TVIN_x_in);
aesl_fh.touch(AUTOTB_TVOUT_x_in);
CodeState = DUMP_INPUTS;
// print x_in Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_x_in, __xlx_sprintf_buffer.data());
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_x_in);

    std::string s(__xlx_tmp_lv.to_string(SC_HEX));
    aesl_fh.write(AUTOTB_TVIN_x_in, s.append("\n")); 
  }
...
float ap_return = fir_mmio_hw_stub_wrapper(__xlx_apatb_param_x_in);
