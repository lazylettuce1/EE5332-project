...
entity fir_mmio_control_s_axi is
generic (
...
end entity fir_mmio_control_s_axi;
...
architecture behave of fir_mmio_control_s_axi is
    ...
    constant ADDR_X_IN_DATA_0 : INTEGER := 16#18#;
    constant ADDR_X_IN_CTRL   : INTEGER := 16#1c#;
