...
// wrapc file define:
#define AUTOTB_TVIN_A_0 "../tv/cdatafile/c.matVecMul.autotvin_A_0.dat"
#define AUTOTB_TVOUT_A_0 "../tv/cdatafile/c.matVecMul.autotvout_A_0.dat"
// wrapc file define:
#define AUTOTB_TVIN_A_1 "../tv/cdatafile/c.matVecMul.autotvin_A_1.dat"
#define AUTOTB_TVOUT_A_1 "../tv/cdatafile/c.matVecMul.autotvout_A_1.dat"
// wrapc file define:
#define AUTOTB_TVIN_A_2 "../tv/cdatafile/c.matVecMul.autotvin_A_2.dat"
#define AUTOTB_TVOUT_A_2 "../tv/cdatafile/c.matVecMul.autotvout_A_2.dat"
// wrapc file define:
#define AUTOTB_TVIN_A_3 "../tv/cdatafile/c.matVecMul.autotvin_A_3.dat"
#define AUTOTB_TVOUT_A_3 "../tv/cdatafile/c.matVecMul.autotvout_A_3.dat"
// wrapc file define:
...
// wrapc file define:
#define AUTOTB_TVIN_no_of_vectors "../tv/cdatafile/c.matVecMul.autotvin_no_of_vectors.dat"
#define AUTOTB_TVOUT_no_of_vectors "../tv/cdatafile/c.matVecMul.autotvout_no_of_vectors.dat"
// wrapc file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_A_0 "../tv/rtldatafile/rtl.matVecMul.autotvout_A_0.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_A_1 "../tv/rtldatafile/rtl.matVecMul.autotvout_A_1.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_A_2 "../tv/rtldatafile/rtl.matVecMul.autotvout_A_2.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_A_3 "../tv/rtldatafile/rtl.matVecMul.autotvout_A_3.dat"
// tvout file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_no_of_vectors "../tv/rtldatafile/rtl.matVecMul.autotvout_no_of_vectors.dat"
// tvout file define:
...
string get_depth_list () {
  ...
  total_list << "{no_of_vectors " << no_of_vectors_depth << "}\n";
...
extern "C" void matVecMul_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, int, int, int);
...
//no_of_vectors
aesl_fh.touch(AUTOTB_TVIN_no_of_vectors);
aesl_fh.touch(AUTOTB_TVOUT_no_of_vectors);
//row_size
...
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_A_0)[j];
  ...
  tcl_file.set_num(1024, &tcl_file.A_0_depth);
...
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_A_1)[j];
  ...
  tcl_file.set_num(1024, &tcl_file.A_1_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_A_1, __xlx_sprintf_buffer.data());
}
...
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_A_2)[j];
  ...
  tcl_file.set_num(1024, &tcl_file.A_2_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_A_2, __xlx_sprintf_buffer.data());
}
...
sc_bv<16> __xlx_tmp_lv = ((short*)__xlx_apatb_param_A_3)[j];
  ...
  tcl_file.set_num(1024, &tcl_file.A_3_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_A_3, __xlx_sprintf_buffer.data());
}
// data
...
// print no_of_vectors Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_no_of_vectors, __xlx_sprintf_buffer.data());
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_no_of_vectors);

    std::string s(__xlx_tmp_lv.to_string(SC_HEX));
    aesl_fh.write(AUTOTB_TVIN_no_of_vectors, s.append("\n")); 
  }
  tcl_file.set_num(1, &tcl_file.no_of_vectors_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_no_of_vectors, __xlx_sprintf_buffer.data());
}
