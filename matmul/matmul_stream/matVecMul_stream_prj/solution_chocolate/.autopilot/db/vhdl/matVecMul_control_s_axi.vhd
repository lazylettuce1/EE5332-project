...
entity matVecMul_control_s_axi is
generic (
...
end entity matVecMul_control_s_axi;
...
architecture behave of matVecMul_control_s_axi is
    ...
    constant ADDR_NO_OF_VECTORS_DATA_0 : INTEGER := 16#0010#;
    constant ADDR_NO_OF_VECTORS_CTRL   : INTEGER := 16#0014#;
    constant ADDR_ROW_SIZE_DATA_0      : INTEGER := 16#0018#;
    constant ADDR_ROW_SIZE_CTRL        : INTEGER := 16#001c#;
    constant ADDR_COL_SIZE_DATA_0      : INTEGER := 16#0020#;
    constant ADDR_COL_SIZE_CTRL        : INTEGER := 16#0024#;
    constant ADDR_A_0_BASE             : INTEGER := 16#0800#;
    constant ADDR_A_0_HIGH             : INTEGER := 16#0fff#;
    constant ADDR_A_1_BASE             : INTEGER := 16#1000#;
    constant ADDR_A_1_HIGH             : INTEGER := 16#17ff#;
    constant ADDR_A_2_BASE             : INTEGER := 16#1800#;
    constant ADDR_A_2_HIGH             : INTEGER := 16#1fff#;
    constant ADDR_A_3_BASE             : INTEGER := 16#2000#;
    constant ADDR_A_3_HIGH             : INTEGER := 16#27ff#;
    ...
    signal int_no_of_vectors   : UNSIGNED(31 downto 0) := (others => '0');
    signal int_row_size        : UNSIGNED(31 downto 0) := (others => '0');
    signal int_col_size        : UNSIGNED(31 downto 0) := (others => '0');
    -- memory signals
    signal int_A_0_address0    : UNSIGNED(8 downto 0);
    signal int_A_0_ce0         : STD_LOGIC;
    signal int_A_0_q0          : UNSIGNED(31 downto 0);
    signal int_A_0_address1    : UNSIGNED(8 downto 0);
    ...
    signal int_A_0_shift0      : UNSIGNED(0 downto 0);
    signal int_A_1_address0    : UNSIGNED(8 downto 0);
    signal int_A_1_ce0         : STD_LOGIC;
    signal int_A_1_q0          : UNSIGNED(31 downto 0);
    signal int_A_1_address1    : UNSIGNED(8 downto 0);
    ...
    signal int_A_1_shift0      : UNSIGNED(0 downto 0);
    signal int_A_2_address0    : UNSIGNED(8 downto 0);
    signal int_A_2_ce0         : STD_LOGIC;
    signal int_A_2_q0          : UNSIGNED(31 downto 0);
    signal int_A_2_address1    : UNSIGNED(8 downto 0);
    ...
    signal int_A_2_shift0      : UNSIGNED(0 downto 0);
    signal int_A_3_address0    : UNSIGNED(8 downto 0);
    signal int_A_3_ce0         : STD_LOGIC;
    signal int_A_3_q0          : UNSIGNED(31 downto 0);
    signal int_A_3_address1    : UNSIGNED(8 downto 0);
    ...
    signal int_A_3_shift0      : UNSIGNED(0 downto 0);

    component matVecMul_control_s_axi_ram is
        generic (
    ...
    end component matVecMul_control_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_A_0
int_A_0 : matVecMul_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_A_0_q1);
-- int_A_1
int_A_1 : matVecMul_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_A_1_q1);
-- int_A_2
int_A_2 : matVecMul_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_A_2_q1);
-- int_A_3
int_A_3 : matVecMul_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_A_0_read = '0') and (int_A_1_read = '0') and (int_A_2_read = '0') and (int_A_3_read = '0') else '0';
    RVALID    <= RVALID_t;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_NO_OF_VECTORS_DATA_0 =>
                        rdata_data <= RESIZE(int_no_of_vectors(31 downto 0), 32);
                    when ADDR_ROW_SIZE_DATA_0 =>
                        rdata_data <= RESIZE(int_row_size(31 downto 0), 32);
                    when ADDR_COL_SIZE_DATA_0 =>
                        rdata_data <= RESIZE(int_col_size(31 downto 0), 32);
                    when others =>
                        NULL;
                    end case;
...
-- ----------------------- Register logic ----------------
    ...
    no_of_vectors        <= STD_LOGIC_VECTOR(int_no_of_vectors);
    row_size             <= STD_LOGIC_VECTOR(int_row_size);
    col_size             <= STD_LOGIC_VECTOR(int_col_size);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_NO_OF_VECTORS_DATA_0) then
                    int_no_of_vectors(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_no_of_vectors(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_ROW_SIZE_DATA_0) then
                    int_row_size(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_row_size(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_COL_SIZE_DATA_0) then
                    int_col_size(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_col_size(31 downto 0));
                end if;
            end if;
        end if;
    end process;
...
-- ----------------------- Memory logic ------------------
    -- A_0
    int_A_0_address0     <= SHIFT_RIGHT(UNSIGNED(A_0_address0), 1)(8 downto 0);
    int_A_0_ce0          <= A_0_ce0;
    A_0_q0               <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_A_0_q0, TO_INTEGER(int_A_0_shift0) * 16)(15 downto 0));
    int_A_0_address1     <= raddr(10 downto 2) when ar_hs = '1' else waddr(10 downto 2);
    ...
    -- A_1
    int_A_1_address0     <= SHIFT_RIGHT(UNSIGNED(A_1_address0), 1)(8 downto 0);
    int_A_1_ce0          <= A_1_ce0;
    A_1_q0               <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_A_1_q0, TO_INTEGER(int_A_1_shift0) * 16)(15 downto 0));
    int_A_1_address1     <= raddr(10 downto 2) when ar_hs = '1' else waddr(10 downto 2);
    ...
    -- A_2
    int_A_2_address0     <= SHIFT_RIGHT(UNSIGNED(A_2_address0), 1)(8 downto 0);
    int_A_2_ce0          <= A_2_ce0;
    A_2_q0               <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_A_2_q0, TO_INTEGER(int_A_2_shift0) * 16)(15 downto 0));
    int_A_2_address1     <= raddr(10 downto 2) when ar_hs = '1' else waddr(10 downto 2);
    ...
    -- A_3
    int_A_3_address0     <= SHIFT_RIGHT(UNSIGNED(A_3_address0), 1)(8 downto 0);
    int_A_3_ce0          <= A_3_ce0;
    A_3_q0               <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_A_3_q0, TO_INTEGER(int_A_3_shift0) * 16)(15 downto 0));
    int_A_3_address1     <= raddr(10 downto 2) when ar_hs = '1' else waddr(10 downto 2);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (A_0_ce0 = '1') then
                    int_A_0_shift0 <= UNSIGNED(A_0_address0(0 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (A_1_ce0 = '1') then
                    int_A_1_shift0 <= UNSIGNED(A_1_address0(0 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (A_2_ce0 = '1') then
                    int_A_2_shift0 <= UNSIGNED(A_2_address0(0 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (A_3_ce0 = '1') then
                    int_A_3_shift0 <= UNSIGNED(A_3_address0(0 downto 0));
                end if;
            end if;
        end if;
    end process;
...
entity matVecMul_control_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity matVecMul_control_s_axi_ram;

architecture behave of matVecMul_control_s_axi_ram is
