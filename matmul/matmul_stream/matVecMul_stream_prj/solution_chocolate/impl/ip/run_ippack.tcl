...
set Library     "hls"
set IPName      "matVecMul"
set Version     "1.0"
set DisplayName "matVecMul"
set Revision    "2101010000"
set Description "MatVecMul for Pynq"
set Device      "zynq"
set AutoFamily  ""
...
set xo_kernel_name "matVecMul"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/aion/my_ws/ee5332/matmul/matmul_stream/matVecMul_stream_prj/solution_chocolate"
set debug_dir "/home/aion/my_ws/ee5332/matmul/matmul_stream/matVecMul_stream_prj/solution_chocolate/.debug"
set xo_hls_files_dir ""
set hdl_module_list {matVecMul_flow_control_loop_pipe_sequential_init
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 RESERVED_3 R 0 "Reserved.  0s on read." } { 10 22 RESERVED_4 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 no_of_vectors W 0x0 "Data signal of no_of_vectors" {{0 32 no_of_vectors W 0 "Bit 31 to 0 of no_of_vectors"}}} {0x18 row_size W 0x0 "Data signal of row_size" {{0 32 row_size W 0 "Bit 31 to 0 of row_size"}}} {0x20 col_size W 0x0 "Data signal of col_size" {{0 32 col_size W 0 "Bit 31 to 0 of col_size"}}}}
        memories "A_0 {base_address 2048 range 2048} A_1 {base_address 4096 range 2048} A_2 {base_address 6144 range 2048} A_3 {base_address 8192 range 2048}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 1863 II x}
...
source -notrace "/mnt/xilinx/Vitis_HLS/2021.1/common/scripts/ipxhls.tcl"
