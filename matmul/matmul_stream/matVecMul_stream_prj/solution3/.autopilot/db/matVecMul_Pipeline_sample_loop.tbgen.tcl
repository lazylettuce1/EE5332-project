...
set C_modelArgList {
	...
	{ x_localbuff_V int 16 regular {array 64 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "col_size", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "x_localbuff_V", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ x_localbuff_V_address0 sc_out sc_lv 6 signal 8 } 
	{ x_localbuff_V_ce0 sc_out sc_logic 1 signal 8 } 
	{ x_localbuff_V_we0 sc_out sc_logic 1 signal 8 } 
	{ x_localbuff_V_d0 sc_out sc_lv 16 signal 8 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "x_localbuff_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "x_localbuff_V", "role": "address0" }} , 
 	{ "name": "x_localbuff_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "x_localbuff_V", "role": "ce0" }} , 
 	{ "name": "x_localbuff_V_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "x_localbuff_V", "role": "we0" }} , 
 	{ "name": "x_localbuff_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "x_localbuff_V", "role": "d0" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "x_localbuff_V", "Type" : "Memory", "Direction" : "O"}],
		"Loop" : [
...
set ArgLastReadFirstWriteLatency {
	matVecMul_Pipeline_sample_loop {
		...
		x_localbuff_V {Type O LastRead -1 FirstWrite 0}}}
...
set Spec2ImplPortList { 
	...
	x_localbuff_V { ap_memory {  { x_localbuff_V_address0 mem_address 1 6 }  { x_localbuff_V_ce0 mem_ce 1 1 }  { x_localbuff_V_we0 mem_we 1 1 }  { x_localbuff_V_d0 mem_din 1 16 } } }
}
