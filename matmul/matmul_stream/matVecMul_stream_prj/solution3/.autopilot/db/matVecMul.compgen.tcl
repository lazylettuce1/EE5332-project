...
set ID 12
set hasByteEnable 0
set MemName matVecMul_x_localbuff_V
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 13 \
			corename matVecMul_control_axilite \
			name matVecMul_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler matVecMul_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
# RegSlice definition:
set ID 28
set RegSliceName matVecMul_regslice_both
set RegSliceInstName matVecMul_regslice_both_U
set CoreName ap_simcore_matVecMul_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
