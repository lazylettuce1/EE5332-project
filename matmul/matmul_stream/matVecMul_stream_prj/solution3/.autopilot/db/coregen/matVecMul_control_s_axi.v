...
// ==============================================================
`timescale 1ns/1ps
module matVecMul_control_s_axi
#(parameter
    ...
    output wire [31:0]                   row_size,
    output wire [31:0]                   col_size,
    input  wire [11:0]                   A_address0,
    input  wire                          A_ce0,
...
localparam
    ...
    ADDR_IER             = 14'h0008,
    ADDR_ISR             = 14'h000c,
    ADDR_ROW_SIZE_DATA_0 = 14'h0010,
    ADDR_ROW_SIZE_CTRL   = 14'h0014,
    ADDR_COL_SIZE_DATA_0 = 14'h0018,
    ADDR_COL_SIZE_CTRL   = 14'h001c,
    ADDR_A_BASE          = 14'h2000,
    ADDR_A_HIGH          = 14'h3fff,
    WRIDLE               = 2'd0,
    WRDATA               = 2'd1,
    WRRESP               = 2'd2,
    WRRESET              = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_ROW_SIZE_DATA_0: begin
                    rdata <= int_row_size[31:0];
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_ROW_SIZE_DATA_0)
            int_row_size[31:0] <= (WDATA[31:0] & wmask) | (int_row_size[31:0] & ~wmask);
    end
end
...
module matVecMul_control_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,
